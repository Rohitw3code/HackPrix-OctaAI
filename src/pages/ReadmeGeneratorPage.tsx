  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-slate-950 to-black flex flex-col">
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Fixed Left Panel - Input Form */}
        <div className="w-full lg:w-1/3 border-r border-slate-800/50 bg-black/40 flex flex-col flex-shrink-0">
        ...
        <div className="flex-1 flex flex-col bg-black/20">
          ...
          <div className="flex items-center justify-between p-4 sm:p-6 border-b border-slate-800/50 bg-black/40 flex-shrink-0">
            <div className="flex items-center space-x-3">
              <h3 className="text-lg font-semibold text-white">README Output</h3>
              {generatedReadme && (
                <div className="flex items-center space-x-1 bg-black/60 rounded-lg p-1">
                  <button
            ...
            {!generatedReadme ? (
              ...
              <div>
                {viewMode === 'edit' ? (
                  ...
                  <div className="prose prose-invert max-w-none p-6 bg-[#0d1117] border border-[#30363d] rounded-xl text-gray-300 overflow-x-auto">
                    <ReactMarkdown
                      ...
                      components={{
                        code({ node, inline, className, children, ...props }) {
                          ...
                          return !inline ? (
                            <div className="bg-[#161b22] border border-[#30363d] rounded-md my-2">
                            ...
                            <code className="bg-[#161b22] text-gray-300 px-1.5 py-0.5 rounded" {...props}>
                              {children}
                            </code>
                          );
                        },
                        table({ children }) {
                          return (
                            <div className="overflow-x-auto">
                              <table className="border-collapse border border-[#30363d] my-2">{children}</table>
                            </div>
                          );
                        },
                        th({ children }) {
                          return <th className="border border-[#30363d] px-4 py-2 bg-[#161b22]">{children}</th>;
                        },
                        td({ children }) {
                          return <td className="border border-[#30363d] px-4 py-2">{children}</td>;
                        },
                        a({ href, children }) {
                          return (
                        ...
                        h6: ({ node, ...props }) => <h6 className="text-base font-bold my-2" {...props} />
                      }}
                    >
                      {generatedReadme}
                    </ReactMarkdown>
                  ...
                  <pre className="whitespace-pre-wrap text-sm text-gray-300 leading-relaxed font-mono bg-[#0d1117] p-4 rounded-xl border border-[#30363d] overflow-x-auto">
                    {generatedReadme}
                  </pre>
                )}
              </div>
